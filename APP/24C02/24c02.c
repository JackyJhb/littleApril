...
/****************************************************************************
* 名    称: uint8_t void MCU_Send_Ack(void)
...
/****************************************************************************
* 名    称: void IIC_write_OneByte(uint8_t Senddata)
* 功    能：IIC写一个字节到EEPROM	
...
/****************************************************************************
* 名    称: void IIC_Read_OneByte(uint8_t Senddata)
* 功    能：IIC读取一个字节
...
/****************************************************************************
* 名    称: u32 Buf_4Byte(uint8_t *pBuffer,u32 Date_4Byte,uint8_t Byte_num,uint8_t mode)
* 功    能：多位数与字节互转
